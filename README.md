...
| $$n$$ | $$n_2$$ | $$p$$ | $$q$$ | mask |
|-----|-------|-----|-----|----|
| $1081$ | $0000010000111001_2$ | $1$ | $0$ | $0000011111111111_2$ |
|        | $1000011100100000_2$ |     |     | $1111111111100000_2$ |
...
| $$n$$ | $$n_2$$ | $$p$$ | $$q$$ | mask |
|-----|-------|-----|-----|----|
| $4094$ | $0000111111111110_2$ | $0$ | $0$ | $0000111111111111_2$ |
|        | $1111111111110000_2$ | $1$ | $0$ | $1111111111110000_2$ |
|        | $0000000000000000_2$ | $12$ | $1$ | $0000000000000000-2$ |
...
| Step | $p$ | $q$ | shift | $n$ |
|------|-----|-----|-------|-----|
|  0   | 74  | 106 |   | $0000000000000000_2$ |
|  1   | 106 | 74  | 0 | $1111111111111111_2$ |
|  2   | 74  | 32  | 1 | $0000000000000000_2$ |
|  3   | 32  | 10  | 2 | $0011111111111111_2$ |
|  4   | 10  | 2   | 3 | $0001100000000000_2$ |
|  5   | 2   | 0   | 5 | $0000011100111111_2$ |
